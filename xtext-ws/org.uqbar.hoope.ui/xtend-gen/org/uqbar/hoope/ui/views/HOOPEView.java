...
public class HOOPEView extends ViewPart {
  ...
  public void createPartControl(final Composite parent) {
    HOOPEView.LOGGER.debug("Creo el canvas");
  ...
  public void setFocus() {
    HOOPEView.LOGGER.debug("Estoy en foco!");
    ...
    final IUnitOfWork<Object,XtextResource> _function = new IUnitOfWork<Object,XtextResource>() {
        public Object exec(final XtextResource it) throws Exception {
          ...
          if (!_notEquals) {
            ...
            boolean _hasError = HOOPEView.this.hasError(hooplEditor);
