...
* generated by Xtext
*/
package org.uqbar.ui.contentassist.antlr;
...
public class HoopeParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.uqbar.ui.contentassist.antlr.internal.InternalHoopeParser createParser() {
		org.uqbar.ui.contentassist.antlr.internal.InternalHoopeParser result = new org.uqbar.ui.contentassist.antlr.internal.InternalHoopeParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMessageAccess().getParamsAssignment_5_0(), "rule__Message__ParamsAssignment_5_0");
					put(grammarAccess.getMessageAccess().getParamsAssignment_5_1_1(), "rule__Message__ParamsAssignment_5_1_1");
					put(grammarAccess.getMessageAccess().getTypeAssignment_8(), "rule__Message__TypeAssignment_8");
					put(grammarAccess.getMessageAccess().getBodyAssignment_9(), "rule__Message__BodyAssignment_9");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.uqbar.ui.contentassist.antlr.internal.InternalHoopeParser typedParser = (org.uqbar.ui.contentassist.antlr.internal.InternalHoopeParser) parser;
