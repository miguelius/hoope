...
public class HoopeSyntacticSequencer extends AbstractSyntacticSequencer {

	protected HoopeGrammarAccess grammarAccess;
	protected AbstractElementAlias match_Program_SemicolonKeyword_1_1_q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (HoopeGrammarAccess) access;
		match_Program_SemicolonKeyword_1_1_q = new TokenAlias(false, true, grammarAccess.getProgramAccess().getSemicolonKeyword_1_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_Program_SemicolonKeyword_1_1_q.equals(syntax))
				emit_Program_SemicolonKeyword_1_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ';'?
	 */
	protected void emit_Program_SemicolonKeyword_1_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
