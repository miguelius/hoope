...
public class HoopeImplicitlyImportedTypes extends ImplicitlyImportedTypes {
  protected List<Class<? extends Object>> getStaticImportClasses() {
    ...
    Iterable<Class<? extends Object>> _plus = Iterables.<Class<? extends Object>>concat(_staticImportClasses, Collections.<Class<?>>unmodifiableList(Lists.<Class<?>>newArrayList(Math.class, System.class)));
